...
public class _QueueSBHome_Stub extends Stub implements QueueSBHome {
    
    private static final String[] _type_ids = {
        "RMI:th.co.msat.motor.queuemanager.QueueSBHome:0000000000000000", 
    ...
    public QueueSB create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (QueueSB) in.read_Object(QueueSB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",th.co.msat.motor.queuemanager.QueueSBHome.class);
            if (so == null) {
                return create();
            }
            try {
                QueueSB result = ((th.co.msat.motor.queuemanager.QueueSBHome)so.servant).create();
                return (QueueSB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
