...
public class _NotificationFacadeHome_Stub extends Stub implements NotificationFacadeHome {
    
    private static final String[] _type_ids = {
        "RMI:th.co.msat.motor.database.NotificationFacadeHome:0000000000000000", 
    ...
    public NotificationFacade create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (NotificationFacade) in.read_Object(NotificationFacade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",th.co.msat.motor.database.NotificationFacadeHome.class);
            if (so == null) {
                return create();
            }
            try {
                NotificationFacade result = ((th.co.msat.motor.database.NotificationFacadeHome)so.servant).create();
                return (NotificationFacade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
