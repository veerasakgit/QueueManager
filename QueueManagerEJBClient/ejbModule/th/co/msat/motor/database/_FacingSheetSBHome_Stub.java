...
public class _FacingSheetSBHome_Stub extends Stub implements FacingSheetSBHome {
    
    private static final String[] _type_ids = {
        "RMI:th.co.msat.motor.database.FacingSheetSBHome:0000000000000000", 
    ...
    public FacingSheetSB create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (FacingSheetSB) in.read_Object(FacingSheetSB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",th.co.msat.motor.database.FacingSheetSBHome.class);
            if (so == null) {
                return create();
            }
            try {
                FacingSheetSB result = ((th.co.msat.motor.database.FacingSheetSBHome)so.servant).create();
                return (FacingSheetSB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
