...
public class _FacingSheetSB_Stub extends Stub implements FacingSheetSB {
    ...
    public void putJob(String arg0, String arg1, String arg2, int arg3, long arg4) throws Exception, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    putJob(arg0,arg1,arg2,arg3,arg4);
                    return;
                } finally {
                    _releaseReply(in);
                }
            ...
            ServantObject so = _servant_preinvoke("putJob",th.co.msat.motor.database.FacingSheetSB.class);
            if (so == null) {
                putJob(arg0, arg1, arg2, arg3, arg4);
                return;
            }
            try {
                ((th.co.msat.motor.database.FacingSheetSB)so.servant).putJob(arg0, arg1, arg2, arg3, arg4);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
        ...
        if (!Util.isLocal(this)) {
            try {
                ...
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("callQueueRunningHost", true);
                    out.write_value(arg0,String.class);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
            ...
            ServantObject so = _servant_preinvoke("callQueueRunningHost",th.co.msat.motor.database.FacingSheetSB.class);
            if (so == null) {
                callQueueRunningHost(arg0);
                return;
            }
            try {
                ((th.co.msat.motor.database.FacingSheetSB)so.servant).callQueueRunningHost(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof Exception) {
