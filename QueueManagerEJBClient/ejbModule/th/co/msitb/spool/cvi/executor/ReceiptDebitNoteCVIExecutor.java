 ...
 *
 */
public class ReceiptDebitNoteCVIExecutor extends ExecutorImpl {
	...
	public void execute() throws Exception {
		...
		try {
			System.out.println("============     ReceiptDebit Note CVI Executor ==============");
			   
			    generateDocument.generatePDFDocument(detailVO,false,spoolMessage.getUsername());
					
			} catch (Exception e) {
				
				System.err.println("============ ERROR ReceiptDebit Note CVI Executor ==============");
				  throw e;
		    }
		}
		isAlive = false;
