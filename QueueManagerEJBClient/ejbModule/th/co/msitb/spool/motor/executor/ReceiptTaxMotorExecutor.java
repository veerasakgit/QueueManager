 ...
 *
 */
public class ReceiptTaxMotorExecutor extends ExecutorImpl {
	...
	public void execute() throws Exception {
		...
		if (null != referId && !"".equals(referId)) {
			...
			try {
				System.out.println("============  ReceiptTax Motor Executor ==============");
				generateDocumentImplement.generatePDFDocument(detailVO,false,spoolMessage.getUsername());
			} catch (Exception e) {
				
				System.err.println("============  Error ReceiptTax Motor Executor ==============");
				  throw e;
			}
		}
		isAlive = false;
