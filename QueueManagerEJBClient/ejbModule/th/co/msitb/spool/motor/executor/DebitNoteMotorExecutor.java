 ...
 *
 */
public class DebitNoteMotorExecutor extends ExecutorImpl{
	...
	public void execute() throws Exception {
		...
		if (null != referId && !"".equals(referId)) {
		    ...
		    detailVO.setBillPayment(spoolMessage.getBillPayment());
			
			try {
				
				System.out.println("============  DebitNote Motor Executor ==============");
				generateDocumentImplement.generatePDFDocument(detailVO,false,spoolMessage.getUsername());
			} catch (Exception e) {
				
				System.err.println("============  Error DebitNote Motor Executor ==============");
