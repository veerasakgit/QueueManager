...
import th.co.msitb.spool.core.common.Constants;
 ...
 *
 */
public class Att1MotorExecutor extends ExecutorImpl{
	...
	public void execute() throws Exception {
		...
		if (null != referId && !"".equals(referId)) {
		    ...
		    System.out.println("Att1 executer get Type"+spoolMessage.getTypeId());
			
		  
		 	    
			try {
				System.out.println("============  Att1 Motor Executor ==============");
				generateDocumentImplement.generatePDFDocument(detailVO,true,spoolMessage.getUsername());
			} catch (Exception e) {
				
				System.err.println("============  Error Att1 Motor Executor ==============");
