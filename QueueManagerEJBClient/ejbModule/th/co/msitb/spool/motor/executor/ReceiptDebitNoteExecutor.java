 ...
 *
 */
public class ReceiptDebitNoteExecutor extends ExecutorImpl{
	...
	public void execute() throws Exception {
		...
		if (null != referId && !"".equals(referId)) {
			...
			try {
				System.out.println("============  Application Motor Executor ==============");
			    
				generateDocumentImplement.generatePDFDocument(detailVO,false,spoolMessage.getUsername());
					
			} catch (Exception e) {
				
				System.err.println("============  Error Application Motor Executor ==============");
