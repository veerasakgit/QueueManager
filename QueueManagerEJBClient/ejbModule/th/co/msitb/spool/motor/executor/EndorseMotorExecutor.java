 ...
 *
 */
public class EndorseMotorExecutor extends ExecutorImpl{
	...
	public void execute() throws Exception {
		...
		if (null != referId && !"".equals(referId)) {
			...
			try {
				System.out.println("============  Endorse Motor Executor ==============");
				spool.generatePDFDocument(detailVO,false,spoolMessage.getUsername());
			} catch (Exception e) {
				
				System.err.println("============  Error Endorse Motor Executor ==============");
