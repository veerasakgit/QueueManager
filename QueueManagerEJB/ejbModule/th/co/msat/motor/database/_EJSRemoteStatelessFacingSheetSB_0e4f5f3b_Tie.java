...
public class _EJSRemoteStatelessFacingSheetSB_0e4f5f3b_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessFacingSheetSB_0e4f5f3b target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:th.co.msat.motor.database.FacingSheetSB:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessFacingSheetSB_0e4f5f3b) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 98: 
                    if (method.equals("putJob")) {
                        return putJob(in, reply);
                    }
                case 101: 
                ...
                case 117: 
                    if (method.equals("callQueueRunningHost")) {
                        return callQueueRunningHost(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream putJob(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        String arg1 = (String) in.read_value(String.class);
        String arg2 = (String) in.read_value(String.class);
        int arg3 = in.read_long();
        long arg4 = in.read_longlong();
        try {
            target.putJob(arg0, arg1, arg2, arg3, arg4);
        } catch (Exception ex) {
    ...
    private org.omg.CORBA.portable.OutputStream callQueueRunningHost(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        try {
