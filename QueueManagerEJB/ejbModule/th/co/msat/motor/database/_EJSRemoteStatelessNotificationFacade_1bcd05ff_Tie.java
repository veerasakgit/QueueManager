...
public class _EJSRemoteStatelessNotificationFacade_1bcd05ff_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessNotificationFacade_1bcd05ff target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessNotificationFacade_1bcd05ff) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 18: 
                    if (method.equals("getRegisteredClaim")) {
                        return getRegisteredClaim(in, reply);
                    }
                case 19: 
                    if (method.equals("searchUnAdjustClaim")) {
                        return searchUnAdjustClaim(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream getRegisteredClaim(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        long arg0 = in.read_longlong();
        Collection result;
        try {
            result = target.getRegisteredClaim(arg0);
        } catch (Exception ex) {
    ...
    private org.omg.CORBA.portable.OutputStream searchUnAdjustClaim(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        boolean arg1 = in.read_boolean();
        Collection result;
        try {
            result = target.searchUnAdjustClaim(arg0, arg1);
        } catch (Exception ex) {
            String id = "IDL:java/lang/Ex:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
